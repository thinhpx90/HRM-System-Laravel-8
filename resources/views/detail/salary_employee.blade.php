...
@section('title', 'Employee details by salary')
@section('content')

<div class="container">
  <div class="row my-4 bg-secondary">
    <div class="col ml-5  h2 text-white">Employee by Salary</div>
  ...
  <div class="mb-4">
    <form class="form-inline" action="{{url('salary/filter/employee')}}" method="get">
      <label>From: </label>
      <input type="text" name="from" class="form-control mx-2">
      <label class="ml-3">To: </label>
      <input type="text" name="to" class="form-control mx-2">
